...
<div class="grid grid-cols-3 gap-3 mb-4">
    <div class="bg-emerald-500/10 border border-emerald-500/30 rounded-xl p-3 text-center">
        <p class="text-xs text-slate-500 dark:text-slate-400 mb-1"><?= lang('App.total_in') ?></p>
    ...
    <div class="bg-red-500/10 border border-red-500/30 rounded-xl p-3 text-center">
        <p class="text-xs text-slate-500 dark:text-slate-400 mb-1"><?= lang('App.total_out') ?></p>
        <p class="text-sm font-bold text-red-400"><?= rupiah($totalOut) ?></p>
    </div>
    <div class="<?= ($totalIn-$totalOut)>=0 ? 'bg-emerald-500/10 border-emerald-500/30' : 'bg-red-500/10 border-red-500/30' ?> border rounded-xl p-3 text-center">
        <p class="text-xs text-slate-500 dark:text-slate-400 mb-1"><?= lang('App.difference') ?></p>
        <p class="text-sm font-bold <?= ($totalIn-$totalOut)>=0 ? 'text-emerald-400' : 'text-red-400' ?>"><?= rupiah($totalIn-$totalOut) ?></p>
    </div>
</div>
